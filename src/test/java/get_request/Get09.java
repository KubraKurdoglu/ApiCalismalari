...
*/
    ...
    public void get09(){
        ...
        //set the url
        spec.pathParams("first", "booking", "second", 847);

        //set expected the data

        //buyuk map olusturulurken Once InnerMap(icteki map) olusturulmali, icteki map bu durumda "value" olur distakine gore
        ...
        //karsilastirma yapabilmek icin, map i java cevirmek lazim
        Map<String , Object> actualData = response.as(HashMap.class);//De-serialisation
        System.out.println("actuelData = " + actualData);
