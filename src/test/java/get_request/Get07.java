...
*/
    ...
    //!!!then() methodu sadece "response" da kullanilir.
    ...
    public void get07(){
        ...
        spec.pathParam("first", "todos");//kac tane parametre varsa, metalink ten sonra o kadar ekliyoruz
        ...
        //Print all ids greater than 190 on the console(bunun icin gelen datayi JsonPATH' E CEVIRMEMIZ LAZIM)

        JsonPath jsonPath = response.jsonPath();
        List<Objects> list = jsonPath.getList("findAll{it.id>190}");//it==> items yani unsur, nesne demek
